...
public abstract class UnmodifiableTreeTemplate<E> extends TreeTemplate<E> implements Unmodifiable {

    private Collection<TreeNode<E>> unmodifiable(final Collection<TreeNode<E>> source,
                                                 final ElementTransformer<TreeNode<E>, TreeNode<E>> tf) {
